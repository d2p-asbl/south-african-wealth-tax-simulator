      ...
      tabPanel("Home",
               fluidRow(
                 ...
                 column(5,
                        ...
                        br(),
                        br(),
                        "The detailed companion study to this simulator can be found", tags$a(href="http://www.wid.world/news-article/a-wealth-tax-for-southafrica/", "here."),
                        ...
                        tags$a(href="https://www.wider.unu.edu/sites/default/files/Publications/Working-paper/PDF/wp2020-45.pdf", "the distribution of household wealth in South Africa."),
                        br(), 
                        br(),
